...
class MainFragment : Fragment(R.layout.fragment_main) {
    ...
    private fun showCurrentInstalledMethods(context: Context) {
        Toast
            .makeText(context, splitInstallManager.installedModules.toString(), Toast.LENGTH_SHORT)
            .show()
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        bindings = FragmentMainBinding.bind(view).apply {
            ...
            btnToggleLight.setOnClickListener {
                ...
                showCurrentInstalledMethods(requireContext())
            }
